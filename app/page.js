...
const data = {
  ...
  skills: [
    { name: "C / C++", level: 80 }, { name: "Python", level: 75 }, { name: "Java", level: 70 },
    { name: "SQL", level: 72 }, { name: "UI / UX", level: 78 }, { name: "HR Management", level: 70 }, { name: "Product Management", level: 65 },
  ],
  hobbies: [
    { label: "Reading", icon: "📖" }, { label: "Writing", icon: "✍️" }, { label: "Gaming", icon: "🎮" },
    { label: "Design", icon: "🎨" }, { label: "Basketball", icon: "🏀" },
  ],
};
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          ...
          --mobile-menu-bg: rgba(244,243,248,0.97);
        }
        ...
        html.dark {
          ...
          --nav-bg: rgba(19,17,30,0.92);
          --mobile-menu-bg: rgba(19,17,30,0.97);
        }
        ...
        nav.scrolled { background: var(--nav-bg); backdrop-filter: blur(12px); box-shadow: 0 1px 0 var(--border); }
        ...
        .mobile-menu button {
          background: none; border: none; cursor: pointer; font-family: 'DM Sans', sans-serif;
          font-size: 1rem; color: var(--ink); padding: 0.9rem 1rem; text-align: left;
          border-radius: 10px; transition: 0.2s; border-bottom: 1px solid var(--border);
        }
        ...
        section { min-height: 100vh; padding: 100px 2rem 80px; max-width: 1100px; margin: 0 auto; }
        ...
        .hero::before {
          content: ''; position: absolute; top: -100px; right: -150px; width: 600px; height: 600px;
          background: radial-gradient(circle, rgba(124,131,200,0.12) 0%, transparent 70%); pointer-events: none;
        }
        .hero::after {
          content: ''; position: absolute; bottom: -50px; left: -100px; width: 400px; height: 400px;
          background: radial-gradient(circle, rgba(176,123,158,0.1) 0%, transparent 70%); pointer-events: none;
        }
        .hero-badge {
          display: inline-flex; align-items: center; gap: 8px;
          background: rgba(124,131,200,0.1); border: 1px solid rgba(124,131,200,0.25);
          border-radius: 20px; padding: 6px 14px; font-size: 0.8rem; color: var(--accent);
          font-weight: 500; margin-bottom: 1.5rem; width: fit-content; animation: fadeUp 0.6s ease both;
        }
        .hero h1 {
          font-family: 'Cormorant Garamond', serif; font-size: clamp(5.5rem, 14vw, 11rem);
          font-weight: 700; line-height: 0.9; letter-spacing: -2px; color: var(--ink);
          animation: fadeUp 0.7s 0.1s ease both;
        }
        .hero h1 .line-one { display: block; color: var(--ink); }
        .hero h1 .accent { display: block; color: var(--accent); }
        .hero-sub {
          font-family: 'Libre Baskerville', serif; font-size: 0.92rem; color: var(--ink-light);
          opacity: 0.7; margin: 1.8rem 0 2.5rem; max-width: 440px; line-height: 1.9;
        ...
        .btn-primary {
          ...
          border-radius: 40px; font-family: 'DM Sans', sans-serif; font-size: 0.85rem;
          font-weight: 600; letter-spacing: 0.8px; text-transform: uppercase; cursor: pointer;
          transition: all 0.25s; box-shadow: 0 4px 20px rgba(124,131,200,0.35);
        ...
        .btn-outline {
          ...
          padding: 0.85rem 2rem; border-radius: 40px; font-family: 'DM Sans', sans-serif;
        ...
        .social-link {
          display: flex; align-items: center; gap: 8px; color: var(--ink-light); text-decoration: none;
          font-family: 'DM Sans', sans-serif; font-size: 0.82rem; font-weight: 500; letter-spacing: 0.3px;
          padding: 8px 16px; border: 1px solid var(--border); border-radius: 20px; transition: 0.2s;
        }
        ...
        .hero-ring-label { font-family: 'JetBrains Mono', monospace; font-size: clamp(0.45rem, 1vw, 0.62rem); color: var(--accent); font-weight: 500; letter-spacing: 1px; white-space: nowrap; background: var(--cream); padding: 2px 6px; border-radius: 4px; border: 1px solid rgba(124,131,200,0.2); }
        ...
        * { cursor: none !important; }
        ...
        .footer-quote blockquote { font-family: 'Cormorant Garamond', serif; font-size: clamp(1.1rem, 2.5vw, 1.55rem); font-weight: 600; color: var(--ink); max-width: 680px; margin: 0 auto 1rem; line-height: 1.55; letter-spacing: -0.2px; }
      ...
      <nav className={scrolled ? "scrolled" : ""}>
        ...
        <div className="nav-right">
          <button className="dark-toggle" onClick={() => setDark(!dark)} title="Toggle dark mode">
            {dark ? "☀️" : "🌙"} <span className="toggle-label">{dark ? "Light" : "Dark"}</span>
          </button>
      ...
      <footer>
        ...
        <div className="footer-bottom">
          <div className="footer-inner">
            <div><div className="footer-name">Kevalya Khandelwal</div><div className="footer-tagline">Full Stack · UI/UX · Management</div></div>
